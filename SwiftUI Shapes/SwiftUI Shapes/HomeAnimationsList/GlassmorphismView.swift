...
//  SwiftUI Shapes
//
//  Created by Silviu Nicolae on 27.08.2021.
//
...
struct GlassmorphismView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            LinearGradient(gradient: Gradient(colors: [Color("ColorOne"), Color("ColorOne").opacity(0.9), Color("ColorTwo").opacity(0.8) ,Color("ColorTwo")]), startPoint: .topTrailing, endPoint: .bottomLeading)
